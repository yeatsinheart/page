...
class _AppStoreState extends State<TestAppstore> with TickerProviderStateMixin {
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                '日期',
                                style: TextStyle(fontSize: 12, decoration: TextDecoration.none, color: Colors.black54),
                              ),
                              Padding(
  ...
  Widget createItemView(int index) {
    ...
    var _animationController = AnimationController(vsync: this, duration: const Duration(milliseconds: 200));
