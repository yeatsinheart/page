...
class ImRoute {
  // 主要框架界面
  static Map app = {"frame": "/layout/frame/wechat", "404": "/page/404/undified"};
  // 每个页面
  static Map impl = {"/splash": "/launch/splash/demo", "/": "/wechat/msg","/contact": "/wechat/contact","/discover": "/wechat/discover", "/me": "/page/me/demo"};


  static frame() {
    return NamedViewWidget.getViewWidget(app["frame"]);
  }

  static splash() {
    return NamedViewWidget.getViewWidget(impl["/splash"]);
  }

  static home() {
    return NamedViewWidget.getViewWidget(impl["/"]);
  }
  ...
  static contact() {
    return NamedViewWidget.getViewWidget(impl["/contact"]);
  }

  static discover() {
    return NamedViewWidget.getViewWidget(impl["/discover"]);
  }

  static me() {
    return NamedViewWidget.getViewWidget(impl["/me"]);
  }
    ...
    if (routeName == '/launch') {
      return PageRouteBuilder(
          ...
          pageBuilder: (cxt, ani1, ani2) {
            return FadeTransition(opacity: ani1, child: splash());
          });
    } else if (routeName == '/') {
