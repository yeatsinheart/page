...
gameView(game, height, double radius) {
  return Stack(
    children: <Widget>[
      Positioned.fill(
        child: ClipRRect(
...
观看颠峰对决视频，学习顶级玩家的各种对战策略。"""),
  Game('本周战争游戏推荐', '重磅更新', '点击了解这款游戏', 'images/game3.jpg', """2009年掌上明珠花费千万重金打造，3G时代飞跃经典之巨作《明珠三国》手机网络游戏，横空出世！展现千年三国风起云涌历史话题，颠覆传统手机游戏产品概念，万人同时在线，还原历史战争风云，各路豪侠英雄聚首《明珠三国》。宏大重磅开场，作为掌上明珠第三代手机网络游戏，备受玩家期待和瞩目！ 
  ...
  Game('蜘蛛侠 屌的一批', '编辑喜欢玩', '全新资料片', 'images/game2.png', """战地风暴》（invision）是成都Tap4Fun推出的战争策略手游，荣获App Store官方推荐！游戏主旨围绕着打造最强基地-战胜敌人而展开，玩家在游戏中需要培养自己的基地建筑、同时最大化资源优势、生产足够多的武装力量，从而使自己的基地成为最强的军事堡垒。基地到达一定等级后，还可与其他玩家结成联盟，进行联盟间的战斗，实时交流、互助，体验协同战斗的乐趣！除此之外，《战地风暴》所独有的高清3D画面表现力，将重现现代战争中炮火纷飞的激烈战场。这是一场发生在人与人之间，真实的线上战争！
