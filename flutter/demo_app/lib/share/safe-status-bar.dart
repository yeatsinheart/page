...
status_bar_color(child,{color}) {
  return AnnotatedRegion<SystemUiOverlayStyle>(
    value: SystemUiOverlayStyle(
      ...
      statusBarIconBrightness: AppContext.isDark ? Brightness.dark : Brightness.light,
    ),
    child: child,
  );
}
...
set_status_bar_color(color){
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    statusBarColor: color??Colors.transparent, // 设置状态栏颜色
    statusBarBrightness: AppContext.isDark ? Brightness.dark : Brightness.light,
    statusBarIconBrightness: AppContext.isDark ? Brightness.light : Brightness.dark,
  ));
}