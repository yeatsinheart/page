...
class LanguageStore extends GetxService {
  ...
  Future<Map<String, String>> fetchRemoteTranslations(String langCode) async {
    await Future.delayed(Duration(milliseconds: 3000)); // 模拟网络延迟

    if (langCode == 'zh_CN') {
      return {
        '微信': '微信xxx',
        'testImage': 'https://pic.616pic.com/photoone/00/02/58/618cf527354c35308.jpg!/fw/1120',
      };
    } else {
      return {
        'testImage': 'https://pic.616pic.com/photoone/00/06/02/618e27a728fd34751.jpg!/fw/1120',
        '首页': 'home',
        '发现': 'discover',
        '我': 'me',
        '微信': 'wechat',
