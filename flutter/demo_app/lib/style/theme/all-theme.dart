...
ThemeData getFlutterTheme({Color? bgColor, Color? fontColor, Color? borderColor, Color? shadowColor}) {
  return ThemeData(
    ...
    dialogTheme: DialogThemeData(
      ...
      titleTextStyle: TextStyle(fontSize:AppStore.byRem(.22),color: fontColor ?? ColorFont.get().txt),
      contentTextStyle: TextStyle(fontSize:AppStore.byRem(.22),color: fontColor ?? ColorFont.get().txt),
    ),
    tabBarTheme: TabBarThemeData(
      indicatorColor: AppStore.getMainColor(),
      labelColor: AppStore.getMainColor(),
      labelStyle: TextStyle(fontSize:AppStore.byRem(.22),fontWeight: FontWeight.bold),
      unselectedLabelColor: ColorFont.get().txt,
      unselectedLabelStyle: TextStyle(fontSize:AppStore.byRem(.22),fontWeight: FontWeight.normal),
