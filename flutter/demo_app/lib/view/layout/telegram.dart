...
class _LayoutTelegramState extends State<LayoutTelegram> {
  ...
  /// layout 布局 与底部导航绑定
  final List _pageList = [NamedViewWidget.getViewWidget(ViewKeyPathMap["home"]), NamedViewWidget.getViewWidget(ViewKeyPathMap["contact"]), NamedViewWidget.getViewWidget(ViewKeyPathMap["discover"]), NamedViewWidget.getViewWidget(ViewKeyPathMap["me"])];
  var data = [
