...
<template>
  <div v-if="games.length>0" class="col-4">
    ...
    style="border-radius: .18rem;">
      <div style="width: 100%;position: relative;">
        ...
        <div class="truncate" style="width:100%;text-align: center;position: absolute;bottom: 0;background: linear-gradient(transparent, rgba(1, 1, 1, 0.8));color:#fff;">{{game.name}}</div>
      </div>
    </div>
  </div>
